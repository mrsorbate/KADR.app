                ...
                >
                  <div className="flex items-start gap-3 sm:gap-4">
                    <div className="w-20 sm:w-24 shrink-0">
                      <div className="h-full rounded-xl border border-gray-200 dark:border-gray-700 bg-gray-50/70 dark:bg-gray-800/60 px-2 py-2 sm:py-3 flex flex-col items-center justify-center text-center">
